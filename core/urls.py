...
urlpatterns = [
    ...
    path('', views.seleccionar_direccion, name='seleccionar_direccion'),
    ...
    path('local/<int:local_id>/calificar/', views.calificar_local, name='calificar_local'),
    path('categorias/', views.categorias_movil, name='categorias_movil'),
]